...
python ./libsvm_tools/initial_ranking_with_svm_rank.py ./ ./example/toy/data/train.txt ./example/toy/data/valid.txt ./example/toy/data/test.txt ./tmp/

python ./libsvm_tools/prepare_exp_data_with_svmrank.py ./example/toy/data/ ./tmp/ ./tmp_data/ 136
